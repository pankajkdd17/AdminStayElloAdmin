<%@ Page Title="" Language="C#" MasterPageFile="~/content/admin.master" AutoEventWireup="true" CodeFile="dashboard.aspx.cs" Inherits="dashboard" %>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 zoomnow">
                                            ...
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    <a href="Rooms.aspx">
                                                        <span class="info-box-text dash"><b>Rooms</b></span>  </a>
                                                    <span class="info-box-number" style="color: #ff6a00; text-align: left">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 zoomnow">
                                            ...
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    <a href="Tenants.aspx"><span class="info-box-text dash"><b>Tenants </b></span></a>
                                                    <span class="info-box-number" style="color: #ff6a00; text-align: left">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 zoomnow">
                                            <div class="info-box">
                                                <span class="info-box-icon bg-aqua-active color-palette"><i class="fa fa-home"></i></span>
                                                <div class="info-box-content">
                                                    <span class="info-box-text dash"><b>Room Occupency</b></span>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <span style="color: #f00">Vacant</span>
                                                                <span class="info-box-number" style="color: #f00">
                                                                    <asp:Label ID="lblVacant" runat="server"></asp:Label></span>

                                                            </td>
                                                            <td>
                                                                <span style="color: #b6ff00">Semi Vacant</span>
                                                                <span class="info-box-number" style="color: #b6ff00">
                                                                    <asp:Label ID="lblSemiVacant" runat="server"> </asp:Label></span>

                                                            </td>
                                                            <td>
                                                                <span style="color: #34a507">Full</span>
                                                                <span class="info-box-number" style="color: #34a507">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span style="color: #b6ff00">On going</span>
                                                                <span class="info-box-number" style="color: #b6ff00">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <a href="Dues.aspx">
                                                                    <span style="color: #ff6a00; white-space: nowrap">Dues (<asp:Label ID="lblcountdues" runat="server"></asp:Label>)</span> </a>
                                                            ...
                                                            <td style="visibility: hidden">
                                                                <a href="Expenses.aspx">
                                                                    <span style="color: #ff6a00; white-space: nowrap">Expense (<asp:Label ID="lblcountExpence" runat="server"></asp:Label>)</span></a>
                                                                <span class="info-box-number" style="color: #ff6a00">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 zoomnow">
                                            ...
                                            <div class="info-box">
                                                <span class="info-box-icon bg-aqua-active color-palette"><i class="fa fa-building"></i></span>
                                                <div class="info-box-content">
                                                    <span class="info-box-text dash"><b>Dues</b></span>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <a href="Dues.aspx">
                                                                    <span style="color: #ff6a00; white-space: nowrap">Add Dues</span>
                                                                    <span class="info-box-number" style="color: #ff6a00">
                                                                        <asp:Label ID="lblDues" runat="server"></asp:Label></span>
                                                                </a>
                                                            </td>
                                                            <td style="visibility: hidden">
                                                                <a href="Expenses.aspx">
                                                                    <span style="color: #ff6a00; white-space: nowrap">Add Expense</span>
                                                                    <span class="info-box-number" style="color: #ff6a00">
                                            ...
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    <a href="Bookings.aspx">
                                                        <span class="info-box-text dash"><b>Bookings</b></span></a>
                                                    <span class="info-box-number" style="color: #ff6a00; text-align: left">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6 col-xs-12 zoomnow">
                                            ...
                                            <div class="info-box">
                                                <span class="info-box-icon bg-aqua-active color-palette"><i class="fa fa-bullhorn"></i></span>

                                                <div class="info-box-content">
                                                    <a href="Announcement.aspx"><span class="info-box-text dash"><b>Announcements</b></span> </a>
                                                    <span class="info-box-number" style="color: #ff6a00; text-align: left">
                                                        <asp:Label ID="lblAnnouncement" runat="server"></asp:Label></span>
                                                </div>
                                                <!-- /.info-box-content -->
                                            </div>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12 zoomnow">
                                            ...
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <span class="info-box-number" style="color: #ff6a00; text-align: left">
                                                        <asp:Label ID="lblLeads" runat="server"></asp:Label></span>
                                                </div>
                                                <!-- /.info-box-content -->
                                            </div>
                                            ...
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    <a href="ScheduleVisits.aspx">
                                                        <span class="info-box-text dash"><b>Schedules </b></span></a>
                                                    <span class="info-box-number" style="color: #ff6a00">
