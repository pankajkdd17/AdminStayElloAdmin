<%@ Page Title="" Language="C#" MasterPageFile="~/content/admin.master" AutoEventWireup="true" CodeFile="Dues.aspx.cs" Inherits="content_Dues" %>
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtMonth" class="form-control" TextMode="Month" OnTextChanged="txtMonth_TextChanged" AutoPostBack="true" placeholder="Select Month" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
